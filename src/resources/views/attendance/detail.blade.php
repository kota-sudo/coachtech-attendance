...
<div class="detail__content">
    ...
    <form class="form" method="POST" action="/attendance/detail/{{ $attendance->id }}">
        @csrf
        ...
        @if ($hasPending)
            <div class="form__content">
                ...
                <div class="form__group">
                    ...
                    <div class="form__input-group">
                        <input class="form__textarea readonly" type="text" value="{{ $pendingNote }}" readonly>
                    </div>
                </div>
            </div>
        ...
        @else
            <div class="form__content">
                ...
                <div class="form__group">
                    <p class="form__header">出勤・退勤</p>
                    <div class="form__input-group">
                        <input class="form__input" type="text" name="requested_clock_in" value="{{ $defaultClockIn }}">
                        <p>〜</p>
                        <input class="form__input" type="text" name="requested_clock_out" value="{{ $defaultClockOut }}">
                    </div>
                </div>
                <div class="error-message">
                    <div></div>
                    <div class="error-message__item">
                        @error('requested_clock_in')<p>{{ $message }}</p>@enderror
                        @error('requested_clock_out')<p>{{ $message }}</p>@enderror
                    </div>
                </div>
                <div class="form__group form__break-group">
                    <p class="form__header">休憩</p>
                ...
                <div class="form__group">
                    ...
                    <div class="form__input-group">
                        @if ($attendance->note)
                            <input class="form__textarea readonly" type="text" value="{{ $attendance->note }}" readonly>
                        @endif
                        <input class="form__textarea" name="requested_note" value="{{ $defaultNote }}">
                    </div>
                </div>
                <div class="error-message">
                    <div></div>
                    <div class="error-message__item">
                        @error('requested_note')<p>{{ $message }}</p>@enderror
                    </div>
                </div>
            </div>
            <div class="form__button">
