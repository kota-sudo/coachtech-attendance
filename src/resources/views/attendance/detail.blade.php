            ...
            <div class="form__content">
                ...
                <div class="form__group form__break-group">
                    ...
                    <div class="form__input-wrapper">
                        ...
                        @empty
                            <div class="form__input-group"><span>—</span></div>
                        @endforelse
                    </div>
                </div>
                <div class="form__group">
        ...
        <form class="form" method="POST" action="/attendance/detail/{{ $attendance->id }}">
            ...
            <div class="form__content">
                ...
                <div class="form__group">
                    <p class="form__header">出勤・退勤</p>
                    <div class="form__input-group">
                        <input class="form__input" type="time" name="requested_clock_in" value="{{ $defaultClockIn }}">
                        <p>〜</p>
                        <input class="form__input" type="time" name="requested_clock_out" value="{{ $defaultClockOut }}">
                    </div>
                </div>
                ...
                <div class="form__group">
                    <p class="form__header">修正理由</p>
                    <div class="form__input-group">
                        <textarea class="form__textarea" name="requested_note" rows="4">{{ $defaultNote }}</textarea>
